        ...
        for n in possibleNodes:
            ...
            if(symbolTimestamp.isdigit()) :  
                ...
                try:
                    ...
                    #print "secDiff  ",secDiff
                    #print "secDiff.seconds  ",secDiff.seconds
                    #print "secDiff.Tseconds  ",secDiff.total_seconds()
                    #print "secDiff.seconds/60  ",secDiff.seconds#/60
